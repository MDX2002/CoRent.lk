...
const Hero = () => {
  ...
  >
    ...
    <div className="absolute right-0 top-1/3 transform -translate-y-1/4 px-6 md:px-16 lg:px-24 xl:px-32 text-white">
      ...
      <p className='mt-7 bg-[#49B9FF]/50 px-3.5 py-1 rounded-full'>Find affordable rooms, book instantly, and live comfortably—your perfect shared space starts here!</p>
